...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!consent) {
      ...
      // Aquí puedes incluir el código para activar Google Analytics, Ads, etc.
  }
});
...
function acceptAll() {
  ...
  // Aquí puedes activar todos los scripts
...
function denyAll() {
  ...
  document.getElementById('cookie-banner').style.display = 'none';
  // Aquí puedes desactivar todos los scripts
...
function savePreferences() {
  ...
  document.getElementById('preferences-modal').style.display = 'none';
  // Aquí puedes activar o desactivar scripts según las preferencias
